...
<body>  
    ...
    <div id="wrapper">
        ...
        <section>
            <img src="images/careers/banners.png" alt="Paris" width="100%">
        </section>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="box">
                            ...
                            <p><font size="2">Qualification:
                            <br>-Candidate must possess at least Bachelor's/ College Degree in Architecture or equivalent.
                            <br>-Professional License (Passed the Board/Bar/Professional License) is a plus
                            <br>- At least 2 year(s) of working experience in the related field is required for this position.
                            <br>-Required Skill(s): Fast drafter, efficient in doing tasks. Excellent quality of work.
                            <br>-Preferably 1-4 years experienced employee specialized in Architecture/ Interior Design or Equivalent
                            <br>-Responsible, can meet the deadline, Resourceful, Wide Reader, Patient, Competent and Hardworking.
                            <br><br>Job Description:
                            <br>-Obtain And assemble data to compete the Architectural Design.
                    ...
                    <div class="col-md-6">
                        <div class="box">
                            <h4 style="color: #543E17; font-size: 15px;">Interior <br> Designer</h4>
                    ...
                    <div class="col-md-6">
                        <div class="box">
                            <h4 style="color: #543E17; font-size: 15px;">Project <br> Architect</h4>
                            <p><font size="2">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magnaLorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna<br>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna </font></p>
                        </div>
                    </div><!-- end col -->
