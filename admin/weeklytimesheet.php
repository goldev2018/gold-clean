...
<br>
  <select id="inputGroupSelect04" name="selemployee" required="" class="hidebutton" onchange="this.form.submit()">
...
if (isset($_POST['selemployee'])) {

$weekstart = $_POST['weekstart'];
$weekend = $_POST['weekend'];
echo $selemployee = $_POST['selemployee'];
